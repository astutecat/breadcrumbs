...
import { graphlibToD3 } from "./VisModal";
export const forceDirectedG = (graph, currFile, modal, width, height) => {
    ...
    const indexFromName = (name) => data.nodes.find((node) => node.name === name).id;
    const node = svg
        .append("g")
        .selectAll("circle")
        .data(nodes)
...
//# sourceMappingURL=ForceDirectedG.js.map