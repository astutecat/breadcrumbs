...
import { bfsAdjList, dfsFlatAdjList } from "./VisModal";
import { openOrSwitch } from "obsidian-community-lib";
import { getCurrFile } from "../Utils/ObsidianUtils";
export const circlePacking = (graph, currFile, modal, width, height) => {
    ...
    const simulation = d3
        ...
        .force("collide", d3.forceCollide().strength(0.025).radius(30).iterations(1)); // Force that avoids circle overlapping
