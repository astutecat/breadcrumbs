...
import { dfsAllPaths, getReflexiveClosure, getSubInDirs, } from "../Utils/graphUtils";
const STORE_ID = "core";
class BCStoreEvents extends Events {
}
export class BCStore extends Component {
...
export function createJuggl(plugin, target, initialNodes, args, depthMap = null) {
    try {
