...
export const DIRECTIONS = ["up", "same", "down", "next", "prev"];
/**
...
export const JUGGL_CB_DEFAULTS = {
    // @ts-ignore
    animateLayout: true,
    autoAddNodes: false,
    autoExpand: false,
...
export const JUGGL_TRAIL_DEFAULTS = Object.assign(JUGGL_CB_DEFAULTS, {
    animateLayout: true,
    autoZoom: false,
    fdgdLayout: "d3-force",
    height: "300px",
...
export const blankUserHier = () => {
    return { up: [], same: [], down: [], next: [], prev: [] };
};
export const blankDirObjs = () => {
    return {
        up: {},
        same: {},
        down: {},
...
export const [BC_I_AUNT, BC_I_COUSIN, BC_I_SIBLING_1, BC_I_SIBLING_2, BC_I_REFLEXIVE, BC_I_PARENT,] = [
    "BC-Aunt",
    "BC-Cousin",
    "BC-Sibling-1",
    "BC-Sibling-2",
...
export const [BC_FOLDER_NOTE, BC_FOLDER_NOTE_SUBFOLDERS, BC_FOLDER_NOTE_RECURSIVE, BC_TAG_NOTE, BC_TAG_NOTE_FIELD, BC_TAG_NOTE_EXACT, BC_LINK_NOTE, BC_TRAVERSE_NOTE, BC_REGEX_NOTE, BC_REGEX_NOTE_FIELD, BC_DV_NOTE, BC_DV_NOTE_FIELD, BC_IGNORE, BC_IGNORE_DENDRON, BC_HIDE_TRAIL, BC_ORDER,] = [
    "BC-folder-note",
...
export const DATAVIEW_MISSING = "The Dataview plugin must be installed for this to work";
