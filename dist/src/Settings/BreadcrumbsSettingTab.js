...
export const fragWithHTML = (html) => createFragment((frag) => (frag.createDiv().innerHTML = html));
export const details = (text, parent) => parent.createEl("details", {}, (d) => d.createEl("summary", { text }));
export const subDetails = (text, parent) => parent.createDiv({
...
//# sourceMappingURL=BreadcrumbsSettingTab.js.map