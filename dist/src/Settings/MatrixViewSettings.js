...
export function addMatrixViewSettings(plugin, viewDetails) {
    ...
    new Setting(MLViewDetails)
        ...
        text.inputEl.onblur = async () => {
            ...
            if (value.length <= 5 &&
                ...
                new Notice('The value must be a 5 digit number using only the digits "0", "1", "2", "3", "4"');
            }
        };
    });
    new Setting(MLViewDetails)
    ...
    new Setting(MLViewDetails)
        ...
        await openView(MATRIX_VIEW, MatrixView, value ? "right" : "left");
    }));
}
//# sourceMappingURL=MatrixViewSettings.js.map