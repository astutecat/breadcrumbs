...
export function addRelationSettings(plugin, containerEl) {
    const { settings } = plugin;
    const relationDetails = details("Relationships", containerEl);
    function mermaidDiagram(diagramStr) {
        MarkdownRenderer.renderMarkdown(diagramStr, relationDetails.createDiv(), "", null);
    }
...
//# sourceMappingURL=RelationSettings.js.map